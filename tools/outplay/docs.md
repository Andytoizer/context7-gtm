...
API key/Bearer token; exact public docs need confirmation.
...
Confirm official public API reference and whether docs are customer-gated.

## Sources

- https://outplayhq.com/
- https://support.outplayhq.com/

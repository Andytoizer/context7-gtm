...
Tidio lets agents work with Contacts, Contact Properties, Contact Messages, Messages, Operators, Departments, and Tickets through official API, OpenAPI/spec, llms/AI docs, and SDK surfaces. Check auth, pagination, rate limits, source links, and high write risk before using Tidio in automations.

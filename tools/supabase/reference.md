...
Dense retrieval notes for Supabase. This file is optimized for agents that need auth, object, endpoint-family, pagination, rate-limit, source, and write-risk context without reading the full profile first.

## Stable Identity

- Registry ID: /gtm/supabase
- Slug: supabase
...
- Rate limits: Management API returns X-RateLimit-* headers; Auth has documented endpoint quotas and 429s.
...
- If the returned docs are ambiguous, fetch /tools/supabase/sources and inspect official source links before acting.

## Source Pointers

- Canonical site: https://supabase.com
- supabase.com/docs/guides/getting-started/mcp (source): https://supabase.com/docs/guides/getting-started/mcp
- supabase.com/docs/reference/api/getting-started (source): https://supabase.com/docs/reference/api/getting-started
- supabase.com/docs/guides/auth/rate-limits (source): https://supabase.com/docs/guides/auth/rate-limits

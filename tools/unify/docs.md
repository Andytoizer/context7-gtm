...
Unify lets agents work with Objects, attributes, records, company, person, opportunity, and intent/events through official API, OpenAPI/spec, llms/AI docs, and SDK surfaces. Check auth, pagination, rate limits, source links, and medium write risk before using Unify in automations.

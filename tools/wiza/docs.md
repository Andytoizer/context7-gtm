...
Wiza lets agents work with Individual reveals, credits, company enrichment, prospect search, lists, list contacts, and prospect lists through official MCP, API, OpenAPI/spec, and llms/AI docs surfaces. Check auth, pagination, rate limits, source links, and medium write risk before using Wiza in automations.

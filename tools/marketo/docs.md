...
Adobe Marketo Engage lets agents work with Leads, Persons, Activities, Lists, Companies, Opportunities, and Programs through official API and OpenAPI/spec surfaces plus community MCP and community integration support. Check auth, pagination, rate limits, source links, and high write risk before using Adobe Marketo Engage in automations.

...
Pinecone lets agents work with Indexes, namespaces, records/vectors, metadata, assistants, rerank models, and inference models through official MCP, API, CLI, llms/AI docs, and SDK surfaces. Check auth, pagination, rate limits, source links, and high write risk before using Pinecone in automations.

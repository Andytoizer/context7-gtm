...
PhantomBuster lets agents work with Agents/Phantoms, containers/launches, console output, results, scripts, workspace storage, and LinkedIn leads through official API surfaces plus community integration support. Check auth, pagination, rate limits, source links, and high write risk before using PhantomBuster in automations.
